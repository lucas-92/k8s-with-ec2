...
variable "k8s_subnet_cidr" {
  default = "172.31.96.0/20" // Altere esse valor para o correspondente com sua VPC
}
...
terraform {
  backend "s3" {
    bucket = "k8s-with-ec2" // Passe o nome do Bucket que você criou para armazenar o state
...
module "k8s_provisioner" {
  ...
  vpc_id                = "vpc-01d72729628a3dd28" // ID da sua VPC
